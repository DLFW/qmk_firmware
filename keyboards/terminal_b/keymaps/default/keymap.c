...
#define MT_LALT MT(MOD_RALT, KC_BSPC)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT(
        ...
        KC_LCTL, KC_LALT, SH_TT,                                                             SH_TT,   KC_LALT, KC_RCTL, \
    ...
    [COMP] = LAYOUT(
        ...
        _______, KC_APP,  KC_PSCR, KC_GRV,  KC_NUBS, KC_DEL,      KC_BSPC, KC_QUOT, KC_SCLN, KC_LBRC, KC_MINS, _______, \
